...
class Sizes {
  ...
  static void initScreenAwareConstant(context) {
    ...
    /*Screen Size dependent Constants*/
    screenWidthHalf = ScreenUtil().uiWidthPx / 2;
    screenHeightHalf = ScreenUtil().uiHeightPx / 2;
    screenWidthThird = ScreenUtil().uiWidthPx / 3;
    screenWidthFourth = ScreenUtil().uiWidthPx / 4;
    screenWidthFifth = ScreenUtil().uiWidthPx / 5;
    screenWidthSixth = ScreenUtil().uiWidthPx / 6;
    screenWidthTenth = ScreenUtil().uiWidthPx / 10;
    screenWidthTwelweth = ScreenUtil().uiWidthPx / 12;
    ...
    imageHeight = ScreenUtil().setWidth(220.0);
